...
describe('TownController', () => {
  ...
  describe('With a successful connection', () => {
    ...
    describe('[T2] interactableUpdate events', () => {
      ...
      describe('Poster Session Area updates', () => {
        ...
        it('Updates the poster session area model', () => {
        ...
        it('Emits a posterStarChange event if the number of stars changes', () => {
          const listener = jest.fn();
        ...
        it('Emits a posterTitleEvent event if the title changes', () => {
          const listener = jest.fn();
        ...
        it('Emits a posterImageContentsChange event if the image contents changes', () => {
          const listener = jest.fn();
