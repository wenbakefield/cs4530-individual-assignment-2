...
describe('Poster Image Viewer', () => {
  ...
  describe('React hooks', () => {
    it('Registers exactly one posterStarChange listener', () => {
      act(() => {
    ...
    it('Unregisters exactly the same posterStarChange listener on unmounting', () => {
      act(() => {
    ...
    it('Registers exactly one posterTitleChange listener', () => {
      act(() => {
    ...
    it('Unregisters exactly the same posterTitleChange listener on unmounting', () => {
      act(() => {
    ...
    it('Registers exactly one posterImageContentsChange listener', () => {
      act(() => {
    ...
    it('Unregisters exactly the same posterImageContentsChange listener on unmounting', () => {
      act(() => {
